...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xiestar', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '关注AI、WEB3、理财的码农', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiestar.eu.org', // 网站地址
